            ...
            a = {
                ...
                elements: [{
                    ...
                    elements: [{
                        ...
                        type: "select",
                        width: "100%",
                        datasource: t.graph.getServicesName(),
                        onchange: function (e) {
                            gettaskName(e[0].value);
                            return false;
                        }
                    }, {
                        name: i.State,
...
function WorkflowGraph(e, t, i, n) {
    ...
    a.container = e, a.designer = t, a.suggestionsCache = new Object, a.parametersCache = new Object, void 0 == i && (i = new Object), void 0 == i.Container && (i.Container = "container"), void 0 == i.graphwidth && (i.graphwidth = 1024), void 0 == i.graphheight && (i.graphheight = 768), void 0 == i.DefaultActivityWidth && (i.DefaultActivityWidth = 200), void 0 == i.DefaultActivityHeight && (i.DefaultActivityHeight = 60), void 0 == i.DefaultMoveStep && (i.DefaultMoveStep = 10), void 0 == i.imagefolder && (i.imagefolder = "/images/"), this.Settings = i, this.Settings.ContainerStage = this.container + "_stage", $("#" + this.container).append("<div id='" + this.Settings.ContainerStage + "' class='workflowenginecontainerstage'></div>"), this.Stage = new Konva.Stage({
        ...
        this.getServicesName = function () {

            var pstr = "";
            $.ajax({
                async: false,
                dataType: 'json',
                url: "http://wfutility.azurewebsites.net/api/WorkOrder/GetServices",
                type: 'GET',
                success: function (datastr) {
                    var items = [];
                    var str = "";
                    $.each(datastr, function (key, val) {
                        items.push(val);
                    });
                    pstr = items;
...
var WorkflowDesignerConstants = {
        ...
        ToolbarLabel: {
            ...
            CreateActivityTransition: "Create a Service and a Condition",
            Legend: "Legend",
...
function gettaskName(slectedvalue) {

    $.ajax({
        async: false,
        dataType: 'json',
        url: "http://wfutility.azurewebsites.net/api/WorkOrder/GetTask?servicename=" + slectedvalue,
        type: 'GET',
        success: function (taskstr) {

            $.each(taskstr, function (key, val) {
                $("select[name='State']").append($("<option></option>").val(val).html(val));
            });
