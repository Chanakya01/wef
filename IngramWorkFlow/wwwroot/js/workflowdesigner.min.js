            ...
            a = {
                ...
                elements: [{
                    ...
                    elements: [{
                        ...
                        field: "Name",
                        type: "select",
                        datasource: ["work order review and approval",	 
                                     "Order receiving schedule",	 
                                     "Load receive at Facility/Dock",
                                     "Capture pallet details from a load",	 
                                     "Capture Asset details",	 
                                     "Test",	 
                                       "Repair",	 
                                        "FG / Recycling",	 
                                        "Audit Report Generation",	 
                                        "Generate Invoice and share it with customer",	 
                                        "Collect Payment"]	 
                    }, {
                        name: i.State,
                        field: "State",
                ...
                saveFunc: function(e) {
                    ...
                    t.item.Name = e.Name, t.item.State = e.State, t.item.IsInitial = e.IsInitial, t.item.IsFinal = e.IsFinal, t.item.IsForSetState = e.IsForSetState, t.item.IsAutoSchemeUpdate = e.IsAutoSchemeUpdate, t.item.Implementation = e.Implementation, t.item.PreExecutionImplementation = e.PreExecutionImplementation, t.item.Annotations = e.Annotations, WorkflowDesignerCommon.DataCorrection(t.graph.data), t.graph.Draw(t.graph.data), t.graph.StoreGraphData()
                }
            };
        if (void 0 != this.graph.Settings.forms && void 0 != this.graph.Settings.forms.activity) this.graph.Settings.forms.activity(a);
            ...
            var o = function(e, i) {
                    ...
                    return n &= e.CheckRequired([i], ["Name"], WorkflowDesignerConstants.FieldIsRequired), t.graph.data.Activities.forEach(function(a) {
                        a != t.item && a.Name == i.Name && (n = !1, e.ControlAddError(i.control_Name, WorkflowDesignerConstants.FieldMustBeUnique))
                    }), e.CheckRequired(i.Implementation, ["ActionName", "Order"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), e.CheckRequired(i.PreExecutionImplementation, ["ActionName", "Order"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), e.CheckRequired(i.Annotations, ["Name"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), e.CheckUnique(i.Annotations, ["Name"], WorkflowDesignerConstants.FieldMustBeUnique) || (n = !1), i.Annotations.forEach(function(a) {
                        a != t.item && a.Name == i.Name && (n = !1, e.ControlAddError(i.control_Name, WorkflowDesignerConstants.FieldMustBeUnique))
                    }), n
                },
                r = function(t) {
        ...
        var n = {
            ...
            elements: [{
                ...
                elements: [{
                    ...
                    type: "select",
                    displayfield: "Name",
                    datasource: t.graph.data.Actors
                }]
            }, {
                type: "group",
                elements: [{
        ...
        if (void 0 != this.graph.Settings.forms && void 0 != this.graph.Settings.forms.transition) this.graph.Settings.forms.transition(n);
            ...
            var a = new WorkflowDesignerForm(n),
                o = function(e, i) {
                    ...
                    var a = ["Type"];
                    "Command" == i.Trigger.Type ? a.push("Command.Name") : "Timer" == i.Trigger.Type && a.push("Timer.Name"), n &= e.CheckRequired([i.Trigger], a, WorkflowDesignerConstants.FieldIsRequired), i.Conditions.forEach(function(t) {
                        a = ["Type"], "Action" == t.Type && a.push("Action.ActionName"), n &= e.CheckRequired([t], a, WorkflowDesignerConstants.FieldIsRequired), "Always" == t.Type && i.Conditions.length > 1 ? (n = !1, e.ControlAddError(t.control_Type, WorkflowDesignerConstants.AlwaysConditionShouldBeSingle)) : "Otherwise" == t.Type && i.Conditions.length > 1 && (n = !1, e.ControlAddError(t.control_Type, WorkflowDesignerConstants.OtherwiseConditionShouldBeSingle))
                    });
                    var o = i.control_Conditions.parent().children("h4");
                    return !i.Conditions.length > 0 ? (o.attr("title", WorkflowDesignerConstants.TransitionFormLabel.ConditionsListShouldNotBeEmpty), o.css("cssText", "color: red !important;"), n = !1) : (o.attr("title", void 0), o.css("color", "")), t.graph.data.Transitions.forEach(function(a) {
                        a != t.item && a.Name == i.Name && (n = !1, e.ControlAddError(i.control_Name, WorkflowDesignerConstants.FieldMustBeUnique))
                    }), e.CheckRequired(i.Restrictions, ["Type", "Actor.Name"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), e.CheckRequired(i.Annotations, ["Name"], WorkflowDesignerConstants.FieldIsRequired) || (n = !1), e.CheckUnique(i.Annotations, ["Name"], WorkflowDesignerConstants.FieldMustBeUnique) || (n = !1), n
                },
                r = function(e) {
                    return !!o(a, e) && (a.ClearTempField(e), a.parameters.saveFunc(e), !0)
                };
...
var WorkflowDesignerConstants = {
        ...
        ToolbarLabel: {
            ...
            CreateActivityTransition: "Create an task and a transition",
            Legend: "Legend",
